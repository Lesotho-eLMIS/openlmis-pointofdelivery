...
public abstract class BaseController {
   ...
   *
   * @param type                The type of class for which we wish to retrieve
   *                            historical changes.
   * @param id                  The ID of class for which we wish to retrieve
   *                            historical changes.
   *                            If null, entries are returned regardless of their
   *                            ID.
   * @param author              The author of the changes which should be
   *                            returned.
   *                            If null or empty, changes are returned regardless
   *                            of author.
   * @param changedPropertyName The name of the property about which changes
   *                            should be returned.
   *                            If null or empty, changes associated with any and
   *                            all properties are returned.
   * @param page                A Pageable object with PageNumber and PageSize
  ...
  /*
   * Return JaVers changes for the specified type, optionally filtered by id,
   * author, and property.
   */
  private List<Change> getChangesByType(Class type, UUID id, String author,
     ...
     * findChanges().
     * Whereas the former returns the entire state of the object as it was at each
     * commit, the later
