...
public class WidgetController extends BaseController {
  ...
  /**
   * Allows the creation of a new widget. If the id is specified, it will be
   * ignored.
   */
  @PostMapping
  ...
  /**
   * Retrieves all widgets. Note that an empty collection rather than a 404 should
   * be
   ...
   *                            and "size" (page size) query parameters to the
   *                            request.
   */
