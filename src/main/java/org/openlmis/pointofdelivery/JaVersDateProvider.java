...
/**
 * This class may be used by JaVers to retrieve the LocalDateTime that it
 * associates with commits.
 * It is intended to be used, rather than JaVers' default DateProvider, so as to
 * be explicit and
 * consistent with the use of UTC within JaVers' domain. (Otherwise, JaVers uses
 * the default
...
public class JaVersDateProvider implements DateProvider {
  ...
  public static ZonedDateTime getZonedDateTime(LocalDateTime localDateTime) {
    ...
    /*
     * Get an instant representing localDateTime with the understanding that it was
     * stored
  ...
  /**
   * Returns a ZonedDateTime (in UTC!) nearly a billion years prior to the
   * unixEpoch.
   */
