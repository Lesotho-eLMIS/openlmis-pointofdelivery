...
public class Message {
  ...
  /**
   * Creates a new Message with parameters that optionally may be used when the
   * message is
   * localized.
   *
   * @param messageKey        the key of the message
   * @param messageParameters the ordered parameters for substitution in a
   *                          localized message.
   */
  ...
  /**
   * Value class of a localized message. Useful for JSON serialization, logging,
   * etc...
   */
