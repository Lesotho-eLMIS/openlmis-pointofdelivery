...
import static org.openlmis.pointofdelivery.util.Pagination.DEFAULT_PAGE_NUMBER;
...
import org.openlmis.pointofdelivery.repository.BaseAuditableRepository;
...
public class AuditLogInitializer implements CommandLineRunner {
  ...
  /**
   * This method is part of CommandLineRunner and is called automatically by
   * Spring.
   * 
  ...
  public void run(String... args) {
    ...
    Map<String, Object> repositoryMap = applicationContext.getBeansWithAnnotation(JaversSpringDataAuditable.class);
